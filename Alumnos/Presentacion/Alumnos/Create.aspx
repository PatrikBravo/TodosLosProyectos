  ...
  <div>
        <div>
            ...
            <div class="row">
                ...
                <!--Validacion-->
                <div>
                     <asp:RequiredFieldValidator ID="requeridofechanacimiento" runat="server" ErrorMessage="El campo Fecha de Nacimiento es obligatorio" ControlToValidate="tbfechaNacimiento" CssClass="alert-danger"></asp:RequiredFieldValidator>
            ...
            <div class="row">
                ...
                <!--Validacion-->
                <div>
                    <asp:RequiredFieldValidator ID="requeridocurp" runat="server" ErrorMessage="El campo CURP es obligatorio" ControlToValidate="tbcurp" CssClass="alert-danger"></asp:RequiredFieldValidator>
                    <asp:CustomValidator ID="vacurpYfecha" runat="server" ErrorMessage="La fecha de la CURP no coincide con la fecha de nacimiento" ControlToValidate="tbcurp" CssClass="alert-danger"
                        ClientValidationFunction="curpYfecha"></asp:CustomValidator>
    ...
    <script type="text/javascript">
        function curpYfecha(source, args) {

            let fechanacimiento = $("#<%=tbfechaNacimiento.ClientID%>").val();
            let fechacurp = args.Value.substr(4, 6);

            let fechaNaFormCURP = fechanacimiento.substr(2, 2) + fechanacimiento.substr(5, 2) + fechanacimiento.substr(8, 2);
